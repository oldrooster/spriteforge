...
from app.routes.ai_inpaint import ai_inpaint_bp
from app.routes.scene_map import scene_map_bp
...
app.register_blueprint(ai_inpaint_bp, url_prefix='/api')
app.register_blueprint(scene_map_bp, url_prefix='/api')
